module razor_test_tokens::weth_token {
    ...
    const ASSET_SYMBOL: vector<u8> = b"tWETH";
    const ASSET_NAME: vector<u8> = b"Test Wrapped Ether";
    const DECIMALS: u8 = 8;
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store::create_primary_store_enabled_fungible_asset(
            ...
            utf8(ASSET_SYMBOL),
            DECIMALS,
            utf8(b"https://raw.githubusercontent.com/razorlabsorg/chainlist/refs/heads/main/chain/aptos/asset/WETH.png"),
            utf8(b"https://www.weth.io"),
        );
